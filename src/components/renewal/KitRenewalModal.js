...
const KitRenewalModal = ({
  ...
  return (
    <Modal
      ...
      footer={
        <>
          <AppButton variant="success" onClick={handleCreateRecord}>
            Save
          </AppButton>
          <AppButton variant="danger" onClick={() => setShowModal(false)}>
            Cancel
          </AppButton>
        </>
      }
    ...
    >
      <div className="renewalmodal-content">
        ...
        <div className="renewalmodal-col">
          ...
          <FormLabel htmlFor="kit_renewal.amount">
            Kit Renewal Amount:
          </FormLabel>
          <FormInput
          ...
          <FormLabel htmlFor="kit_renewal.credit_admin">
            Kit Credit Admin:
          </FormLabel>
          <Select
        ...
        {/* Right Column */}
        <div className="renewalmodal-col">
          <FormLabel htmlFor="kit_renewal.start_date">
            Kit Start Date:
          </FormLabel>
          <FormInput
          ...
          <FormLabel htmlFor="prorated">Prorated?</FormLabel>
          <div className="form-group">
            <select
              name="prorated"
              value={formData.prorated.toString()} // Show "true"/"false" as string
              onChange={handleInputChange}
              className="form-control"
            >
              <option value="true">Yes</option>
